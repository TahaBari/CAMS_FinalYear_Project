...
<head>
    ...
    <link rel="stylesheet" href="CSS/stud_dashs.css">
</head>
<body>
...
<div class="buttons">
    ...
    <button onclick="window.location.href='user-profile.php'">Your Profile</button> </br>
    <button onclick="window.location.href='track_admission_status.php'">Track Admission Status</button>
    <button onclick="window.location.href='Admin/merit_list.php'">Merit List</button>
</div>
